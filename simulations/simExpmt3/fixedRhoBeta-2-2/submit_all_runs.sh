...
java -jar ~/beastMCMC/GammaSpikeModelRhoSampling_jar/GammaSpikeModelRhoSampling.jar -overwrite -D seqLength=$SEQLEN -df var.json -DFout seqsim.out.xml ../../seqsim.xml
Rscript ../../scripts/putSequencesIntoJson.R
java -jar ~/beastMCMC/GammaSpikeModelRhoSampling_jar/GammaSpikeModelRhoSampling.jar -overwrite -df var.seq.json -DFout run.out.xml ../../run.xml
EOF
