...
# ---- Simulate parameters ----
java -jar ~/beastMCMC/GammaSpikeModelRhoSampling_origin_jar/GammaSpikeModelRhoSampling.jar -overwrite -D nSims=$NSIMS ../truth.xml
...
# ---- Count stubs and add metadata ----
Rscript ../scripts/writeTreesWithStubs.R
