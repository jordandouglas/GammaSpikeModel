...
public class StumpedTreeConstantDistanceOperator extends TreeOperator {
	...
	final public Input<RealVectorParam<? extends NonNegativeReal>> rateInput = new Input<>("rates", "the rates associated with nodes in the tree for sampling of individual rates among branches.", Input.Validate.REQUIRED);
    ...
    public double proposalInner() {
       ...
       r_x = rates.get(nodeNr); // rate of branch above this node
